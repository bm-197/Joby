export interface Job {
  ...
  about: {
    ...
    start_date: string;
    end_date: string;
    categories: {id: number, val: string}[]
...
export const jobs: Job[] = [
  {
    ...
    "about": {
      ...
      "categories": [{"id": 1, val: "Marketing"}, {"id": 2, val: "Design"}],
  ...
  },
  {
    ...
    "about": {
      ...
      "categories": [{"id": 1, "val": "IT"}, {"id": 2, "val": "Development"}],
  ...
  },
  {
    ...
    "about": {
      ...
      "categories": [{"id": 1, "val": "Design"}, {"id": 2, "val": "Art"}],
      "required_skills": [
        "Adobe Photoshop",
        "Adobe Illustrator",
        "Creativity",
  ...
  },
  {
    ...
    "about": {
      ...
      "categories": [{"id": 1, "val": "Data Science"}, {"id": 2, "val": "Analytics"}],
  ...
  },
  {
    ...
    "about": {
      ...
      "categories": [{"id": 1, val: "Customer Service"}, {"id":2, val: "Support"}],
      "required_skills": [
