      ...
      <div className='px-4'>
        <div className="m-auto w-70 md:w-80 mt-5 flex flex-col gap-2 align-center px-1">
          <div className="flex flex-col gap-5 items-center content-center">
            <h1 className={`${poppins.className} align-middle text-2xl text-slate-800 font-extrabold`}>Sign Up Today!</h1>
          ...
          <div className="text-[12px] mt-4 opacity-70">
            Already have an account? <Link href='/auth/login' className="text-indigo-800 font-bold">Login</Link>
          </div>
